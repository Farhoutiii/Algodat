...
public class Dec2Bin {
    ...
    public String toString() {
        StringBuilder Binaaaar= new StringBuilder();
        for(int j=binStack.size() - 1; j>=0 ; j--){
            int currElen = binStack.get(j);
            Binaaaar.append(Integer.toString(currElen));
        }
        return Binaaaar.toString();
